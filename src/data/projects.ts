export type Project = {
	...
	details: string[];
	tags: string[];
	/** shown on the home page; /projects lists everything regardless */
	featured: boolean;
	repoUrl?: string;
...
export const projects: Project[] = [
	...
	},
	{
		...
		details: [
			"PennOS is a single-process, multi-threaded operating system. Due to course policy, I can’t share the code lest future students be tempted to forgo the arduous process of building their own OS from scratch.",
